...
```json
{
  "summary": "ダッシュボード用の一言コメント（30文字以内。絵文字1〜2個を含め、今月の状況を端的に表現）",
  "body": "ダッシュボード用の詳細分析・アドバイス（200〜400文字。収支の特徴、注目カテゴリ、来月に向けた具体的なアドバイスを含める）",
...
### Slackレポートの例 (Few-shot)
```text
*■ 今日の収支サマリー*
今日は全体で *2,450円* の支出があったよ！💸
主な出費はランチの定食（1,200円）だね。

*■ 予算の状況*
• 食費: 残り *12,300円* (消化率: 68%) ⚠️
今月もあと1週間、ちょっとペースを落とすと安心かも！

*■ ギャル的アドバイス*
コンビニの新作スイーツ、誘惑ヤバいけど週1のご褒美に抑えよ？🍰
浮いたお金で週末アガる予定入れちゃお！✨
```
